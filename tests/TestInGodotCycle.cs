...
public partial class TestInGodotCycle
{
    ...
    /// </summary>
    [Fact]
    public void IsNotInPhysicsProcess1() => Assert.False(Engine.IsInPhysicsFrame());

    /// <summary>
    /// this test will run in the godot process thread. 
    /// </summary>
    [GodotFact(Frame = GodotFactFrame.Process)]
    public void IsNotInPhysicsProcess2() => Assert.False(Engine.IsInPhysicsFrame());

    /// <summary>
    /// this test will run in the godot physics process thread. 
    /// </summary>
    [GodotFact(Frame = GodotFactFrame.PhysicsProcess)]
    public void IsInPhysicsProcess() => Assert.True(Engine.IsInPhysicsFrame());
